...
import interaction.protocol.ReplicationReport;
import interaction.protocol.metadata.IndexMetaData;
import interaction.protocol.metadata.IndexMetaData.Shard;
import interaction.util.CollectionUtil;
...
public abstract class AbstractIndexOperation implements MasterOperation {
    ...
    private void addRunningDeployments(Map<String, List<String>> currentNode2ShardsMap,
        ...
        for (MasterOperation masterOperation : runningOperations) {
            if (masterOperation instanceof AbstractIndexOperation) {
                ...
                for (Map.Entry<String, List<String>> entry : indexOperation.getNewShardsByNodeMap().entrySet()) {
    ...
    private Map<String, List<String>> cloneMap(Map<String, List<String>> currentShard2NodesMap) {
        ...
        Set<Map.Entry<String, List<String>>> entries = currentShard2NodesMap.entrySet();
